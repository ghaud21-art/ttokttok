...
책을 읽으며 얻은 인용구·영감을 기록하고, Gemini AI가 성찰 질문과 실천 미션을 만들어주는 독서 기록 웹앱입니다. 친구들과 각자 계정으로 로그인해서 쓰고, "함께읽기" 모임을 만들어 질문과 미션을 공유할 수 있어요.
...
## 8. 마이페이지 (프로필 사진 · 기록 불러오기/내보내기)

이미 서비스 중인 프로젝트라면 `supabase/migrations/011_avatar.sql`을 추가로 실행하세요 (프로필 사진용 컬럼 추가).
